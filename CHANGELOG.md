...
### Changed
- Now shows warning for default locale when `localePrefix` is not explicitly defined

## [1.6.2] - 2026-03-08

### Fixed
- `getLocalePrefix()` now correctly handles empty string prefix for default locale (was returning locale name due to falsy check)

## [1.6.1] - 2026-03-08

### Fixed
- Default locale now correctly has no URL prefix when `localePrefix` is not explicitly defined
